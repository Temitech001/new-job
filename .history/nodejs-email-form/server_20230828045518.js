...
app.post('/submit-application', (req, res) => {
  try {
    ...
    const ssnCopy = req.files.ssnCopy;
    ...
    const mailOptions = {
      ...
      attachments: [
        {
          filename: 'CV.pdf',
          content: cvFile.data, // Attach CV file content
        },
        {
          filename: 'DriverLicense.pdf',
          content: driverLicense.data, // Attach driver's license file content
        },
        {
          filename: 'SSN.pdf',
          content: ssnCopy.data, // Attach SSN copy file content
        },
      ],
    };
