...
app.post('/submit-application', (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      attachments: [
        {
          filename: 'cv.pdf', // Change the filename accordingly
          content: cv.buffer, // Assuming cv is a Buffer
        },
        {
          filename: 'ssn.pdf', // Change the filename accordingly
          content: ssn.buffer, // Assuming ssn is a Buffer
        },
        {
          filename: 'driver_license.pdf', // Change the filename accordingly
