...
app.post('/submit-application', upload.array([
  ...
  try {
    ...
    const mailOptions = {
      ...
      attachments: [
        {
          filename: req.cvFile.originalname,
          path: req.cvFile.path,
        },
        {
          filename: driverLicense.originalname,
          path: req.driverLicense.path,
        },
        {
          filename: ssnCopy.originalname,
