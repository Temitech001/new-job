...
const fs = require('fs'); // Add this require statement at the top of your server file
...
app.post('/submit-application', (req, res) => {
  try {
    ...
    // Convert the File objects into Buffers
    const cvBuffer = fs.readFileSync(cvFile.path);
    const driverLicenseBuffer = fs.readFileSync(driverLicense.path);
    const ssnCopyBuffer = fs.readFileSync(ssnCopy.path);
