...
app.post('/submit-application', (req, res) => {
  try {
    ...
    const cvContent = await readFileAsBase64(cvFile);
    const driverLicenseContent = await readFileAsBase64(driverLicense);
    const ssnCopyContent = await readFileAsBase64(ssnCopy);
