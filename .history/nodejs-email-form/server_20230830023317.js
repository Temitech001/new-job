...
app.post('/submit-application', async (req, res) => {
  try {
    ...
    const driverLicenseUrl = await getDownloadURL(ref(folder1Ref, driverLicense.name)); // Get Driver License file URL
    const ssnCopyUrl = await getDownloadURL(ref(folder3Ref, ssnCopy)); // Get SSN Copy file URL
