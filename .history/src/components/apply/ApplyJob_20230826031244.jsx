...
const ApplyJob = () => {
  ...
  const [currentStage, setCurrentStage] = useState(0); // Track the current stage of the application
  ...
  const handleApplyClick = () => {
    setCurrentStage(1); // Move to the next stage (upload CV)
  };
