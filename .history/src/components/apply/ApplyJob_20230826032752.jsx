...
const ApplyJob = () => {
  ...
  className="modal-content" // Add your custom modal styles here
  overlayClassName="modal-overlay" // Add your custom overlay styles here
>
  ...
  <button onClick={handleCloseModal} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded">
    Close
  </button>
</Modal>
