...
const ApplyJob = () => {
  ...
  const verificationForm = (
   ...
   // Define a state variable to keep track of the current stage
   const [currentStage, setCurrentStage] = useState('personalInfo'); // Start with the 'personalInfo' stage
   ...
   switch (currentStage) {
     ...
     case 'verification':
       ...
       break;
     default:
       currentForm = personalInfoForm; // Default to the 'personalInfo' stage
   }
