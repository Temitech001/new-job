  ...
  const coverLetterForm = (
    <div>
      ...
      <form onSubmit={() => setCurrentStage('verification')}>
        ...
        <button type="button" onClick={moveToNextStage} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
          Next
        </button>
        ...
        {jobData ? (
          <div>
            ...
            <div className='flex justify-between'>
              ...
              <button onClick={handleApplyClick} className={`bg-${isApplying ? 'red-500' : 'blue-500'} hover:bg-${isApplying ? 'red-600' : 'blue-600'} text-white px-4 py-2 rounded`}>
