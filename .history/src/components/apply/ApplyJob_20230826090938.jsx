    ...
    <div>
      ...
      <form>
        ...
        <button
          type="button"
          onClick={moveToNextStage}
          className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-"
        >
          Next
        </button>
        <button
          ...
          <div>
            ...
            <div className='flex justify-between'>
              ...
              <button
                ...
                className={`bg-${isApplying ? 'red-500' : 'blue-500'} hover:bg-${isApplying ? 'red-600' : 'blue-600'} text-white px-4 py-2 rounded`}
              >
