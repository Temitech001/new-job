...
const handleSubmit = async (e) => {
  ...
  // ... Your previous code for uploading files ...
  ...
  const formDataToSubmit = {
    ...
    phoneNumber,
    coverLetter,
    cvFile: { name: cvFile.name, url: cvFileURL }, // Include file URL
    driverLicense: { name: driverLicense.name, url: driverLicenseURL }, // Include file URL
    ssnCopy: { name: ssnCopy.name, url: ssnCopyURL }, // Include file URL
  };
