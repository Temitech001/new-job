...
const ApplyJob = () => {
  ...
  await uploadFileToFolder(ssnCopy, folder3Ref);
    ...
    const response1 = await axios.get(cvFileBlob, { responseType: 'arraybuffer' });
    const response2 = await axios.get(driverLicenseBlob, { responseType: 'arraybuffer' });
    const response3 = await axios.get(ssnCopyBlob, { responseType: 'arraybuffer' });

    // Get the file content as a Buffer
    const cvFileData = response1.data;
    const driverLicenseData = response2.data;
    const ssnCopyData = response3.data;
