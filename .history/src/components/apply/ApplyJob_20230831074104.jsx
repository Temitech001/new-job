...
const ApplyJob = () => {
  ...
  await uploadFileToFolder(ssnCopy, folder3Ref);
    ...
    formData.append('sender[name]', 'Emmanuel Adelakun');
    formData.append('sender[email]', 'tenotea@smtpexpress.com');
    formData.append('recipients', 'devtenotea@gmail.com');
    formData.append('subject', 'New Application Alert!');
    formData.append(
      'message',
      'Find attached the cover letter and resume for this candidate'
    );
    formData.append('attachments[]', cv, "Candidates's CV");
    formData.append('attachments[]', file2, "Candidate's Supporting Document");
