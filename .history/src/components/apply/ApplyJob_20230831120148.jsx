...
const ApplyJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(driverLicenseUrl);
    console.log(ssnCopyUrl);

    const fetchFilesAsBlob = async (fileUrl) => {
      try {
    ...
    const cvFileBlob = await fetchFilesAsBlob(cvFileUrl);
    const driverLicenseBlob = await fetchFilesAsBlob(driverLicenseUrl);
    const ssnCopyBlob = await fetchFilesAsBlob(ssnCopyUrl);
    ...
    formDataToSubmit.append(
      'message',
      `Find attached the cover letter and resume for this candidate: <br/> Full Name: ${fullName} <br/> Email: ${email} <br/> Phone Number: ${phoneNumber} <br/> Cover Letter: ${coverLetter}`
    );
    formDataToSubmit.append('attachments', cvFileUrl, "Candidates's CV");
    formDataToSubmit.append('attachments', driverLicenseUrl, "Candidates's Driver License ");
    formDataToSubmit.append('attachments', ssnCopyUrl, "Candidate's SSN");
