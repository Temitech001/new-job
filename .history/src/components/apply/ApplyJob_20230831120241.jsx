...
const ApplyJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSubmit.append('attachments', cvFileBlob, "Candidates's CV");
    formDataToSubmit.append('attachments', driverLicenseBlob, "Candidates's Driver License ");
    formDataToSubmit.append('attachments', ssnCopyBlob, "Candidate's SSN");
