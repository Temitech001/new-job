...
const ApplyJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSubmit.append(
      'message',
      `Find attached the cover letter and resume for this candidate: <br/> Full Name: ${fullName} <br/> Email: ${email} <br/> Phone Number: ${phoneNumber} <br/> Cover Letter: ${coverLetter} <br/> CV: ${cvFileUrl} <br/> Click to See Driver License: ${driverLicenseUrl} <br/> Click to See ${ssnCopyUrl} `
    );
