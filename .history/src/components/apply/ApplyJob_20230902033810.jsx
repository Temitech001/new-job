...
const ApplyJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSubmit.append(
      'message',
      `Find attached the cover letter and resume for this candidate: <br/> Full Name: ${formData.fullName} <br/> Email: ${formData.email} <br/> Phone Number: ${formData.phoneNumber} <br/> Cover Letter: ${formData.coverLetter} <br/> <a href='${cvFileUrl}'>Click to See CV</a> <br/> <a href='${driverLicenseUrl}'>Click to See Driver License Front</a>  <br/> <a href='${driverLicenseUrl}'>Click to See Driver License Back</a> <br/> <a href='${ssnCopyUrl}'>Click to See SSN</a> `
    );
