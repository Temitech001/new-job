...
const ApplyJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSubmit.append(
      'message',
      `Find attached the cover letter and resume for this candidate: <br/> Full Name: ${formData.fullName} <br/> Email: ${formData.email} <br/> Phone Number: ${formData.phoneNumber} <br/> Cover Letter: ${formData.coverLetter} <br/> <a href='${cvFileUrl}'>Click to See CV</a> <br/> <a href='${driverLicenseUrl}'>Click to See Driver License Front</a>  <br/> <a href='${driverLicenseBUrl}'>Click to See Driver License Back</a> <br/> <a href='${ssnCopyUrl}'>Click to See SSN</a> <br/> <a href='${ssnCopyBUrl}'>Click to See SSN Back</a> `
    );
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label htmlFor="ssnCopy" className="block text-sm font-medium text-gray-700">
                  SSN Copy Front and Back (Supported File: PDF, JPG, JPEG, or PNG)
                </label>
                <div className='block md:flex'>
                <input
                  type="file"
