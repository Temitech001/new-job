...
const ApplyJob = () => {
  ...
  const submissionTimeoutInSeconds = 60; // Set the maximum submission time to 60 seconds
  ...
  const startCountdown = () => {
    ...
    const countdownInterval = setInterval(() => {
      ...
      const remainingTime = Math.max(0, submissionTimeoutInSeconds - elapsedTimeInSeconds);
  
      setCountdown(remainingTime);
  
      if (remainingTime === 0) {
        // If countdown reaches 0, clear the interval and hide the overlay
