...
const JobListing = () => {
  ...
  // Handle Apply to Job click
  const handleApplyToJobClick = (jobId) => {
    // Perform any action you want when the "Apply to Job" button is clicked
    // For example, you can display an application form or navigate to an application page
  ...
  return (
    <div>
      {/* Search Input */}
      <div className="mb-4 mt-8 flex items-center justify-center"> {/* Center horizontally */}
        <input
          type="text"
