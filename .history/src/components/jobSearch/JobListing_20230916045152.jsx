...
const JobListing = () => {
  ...
  const handleDeleteJob = async (jobId) => {
    try {
      // Delete the job document in Firestore by its ID
      await deleteDoc(doc(db, 'jobList', jobId)); // Change 'jobList' to your collection name
      // Remove the deleted job from the displayed jobs list
  ...
  return (
    <div>
      <div className="mb-4 mt-8 flex items-center justify-center fill-screen">
        <input
          type="text"
