    ...
    <div className="flex items-center justify-center mt-16">
      <div className="flex items-center space-x-4">
        <div className="relative">
          <label htmlFor="what" className="absolute inset-y-0 left-0 pl-2 pt-2 text-gray-600">What</label>
          <input
            type="text"
            id="what"
        ...
        <div className="relative">
          <label htmlFor="where" className="absolute inset-y-0 left-0 pl-2 pt-2 text-gray-600">Where</label>
          <input
            type="text"
            id="where"
