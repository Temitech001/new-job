    ...
    <div className="bg-white shadow-md rounded-lg overflow-hidden border-solid border-2 p-2">
      <div className="p-4 text-left">
        ...
        <div className="flex justify-between mt-2">
          <p className="text-gray-800 bg-gray-100 rounded-lg p-2 text-center text-xs">
          ...
          >
            ...
            <p className="text-gray-800 bg-gray-100 rounded-lg p-2 text-center">Sign in to Apply</p>
          )}
        </div>
      </div>
    </div>
