...
const Job = ({ job }) => {
  ...
  const handleApplyToJobClick = () => {
    // Log the job ID to the console
    console.log('Applied to job with ID:', job.id);

    // You can navigate to the desired page here.
    // For example, navigate to "/apply" when the button is clicked.
    ...
    <div className="bg-white shadow-md rounded-lg overflow-hidden border-solid border-2 p-2">
      <div className="p-4 text-left">
        ...
        <div className="flex justify-between mt-2">
          ...
          {user ? (
          <button
            onClick={handleApplyToJobClick}  // Define a function to handle the Apply to Job button click
