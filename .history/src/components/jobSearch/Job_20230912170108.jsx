  ...
  return (
    <div className="bg-white shadow-md rounded-lg overflow-hidden border-solid border-2 p-2 relative">
      ...
      {isUserAuthorized && (
        ...
        <button
          onClick={onDelete}
          className="bg-red-500 hover:bg-red-600 text-white px-2 md:px-4 md:py-2 rounded absolute bottom-2 left-2"
        >
          Delete
        </button>
        <button
          onClick={onDelete}
          className="bg-green-500 hover:bg-green-600 text-white px-2 md:px-4 md:py-2 rounded absolute bottom-2 left-2"
        >
          Delete
        </button>
        </>
