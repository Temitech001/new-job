    ...
    <div className="flex justify-center items-center h-screen w-2/4 mx-auto mt-2">
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-sm text-gray-400 mb-6">
          By creating an account or logging in, you understand and agree to Indeed's Terms. You also acknowledge our Cookie and Privacy policies. You will receive marketing messages from JobConnect and may opt out at any time by following the unsubscribe link in our messages, or as detailed in our terms.
        </p>
