  ...
  return (
    <div className="bg-gray-100 py-8">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md md:w-2/4 mx-auto">
        ...
        <button className="text-black border-solid border-2 border-grey-400 rounded-lg py-2 px-4 mb-4 w-full hover:bg-gray-100 flex">
        <FcGoogle/> <span className='mx-a'>Continue with Google</span>
        </button>
