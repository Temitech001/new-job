    ...
    <div className="bg-gray-100 py-8">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md md:w-2/3 lg:w-1/2 xl:w-1/3 mx-auto">
        ...
        <p className="text-sm text-gray-400 mb-6">
          By creating an account or logging in, you understand and agree to  Terms. You also acknowledge our Cookie and Privacy policies. You will receive marketing messages from JobConnect360 and may opt out at any time by following the unsubscribe link in our messages, or as detailed in our terms.
        </p>
