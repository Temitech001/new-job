...
const SignIn = () => {
  ...
  const handleRegisterWithEmailAndPassword = async () => {
    try {
      await auth.createUserWithEmailAndPassword(email, password); // Use createUserWithEmailAndPassword with the auth object
  ...
  return (
    <div className="bg-gray-100 py-8">
      <Link to="/" className="text-xl font-semibold text-blue-600">
        <img width="250px" src={process.env.PUBLIC_URL + 'eelogo.png'} alt="Logo" className="mx-auto" />
      </Link>
      <div className="bg-white p-8 rounded-lg shadow-md md:w-2/3 lg:w-1/2 xl:w-1/3 mx-auto">
        ...
        <p className="text-sm text-gray-400 mb-6">By creating an account or logging in, you acknowledge our Cookie and Privacy policies.</p>
        <button onClick={handleSignInWithGoogle} className="text-black border-solid border-2 border-grey-400 rounded-lg py-2 px-4 mb-4 w-full hover:bg-gray-100 flex content-center">
