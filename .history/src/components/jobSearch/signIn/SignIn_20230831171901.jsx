...
import { getAuth, signInWithEmailAndPassword as signInWithEmailPassword } from 'firebase/auth'; // Import signInWithEmailAndPassword
...
const SignIn = () => {
  ...
  const handleSignInWithEmailAndPassword = async () => {
    try {
      await signInWithEmailPassword(auth, email, password); // Use signInWithEmailAndPassword
