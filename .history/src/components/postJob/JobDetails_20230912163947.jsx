        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-2/3 lg:w-1/2 xl:w-1/3">
          ...
          {isEditing ? (
              ...
              <div className="mb-4">
               ...
               <div className="mb-4">
                ...
                <input
                  ...
                  id="tags"
                  name="tags"
                  value={jobData.tags.join(', ')} // Convert tags array to a comma-separated string
                  onChange={(e) => setJobData({ ...jobData, tags: e.target.value.split(', ') })} // Split the string back to an array
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200 focus:outline-none"
            ...
            <div>
              ...
              {/* Tags */}
              <p className="mb-4">
                <strong>Tags:</strong> {jobData.tags.join(', ')}
              </p>
              {/* Work Schedule */}
              <p className="mb-4">
