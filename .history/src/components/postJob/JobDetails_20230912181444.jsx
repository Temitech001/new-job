    ...
    const fetchJobDetails = async () => {
      try {
        ...
        if (jobDocSnap.exists()) {
          ...
          setJobData({
            ...data,
            datePosted: data.datePosted ? data.datePosted.toDate() : null,
          });
  ...
  const handleSaveClick = async () => {
    try {
      ...
      await updateDoc(jobDocRef, {
        ...
        datePosted: Timestamp.fromDate(new Date(jobData.datePosted)), // Convert date to Timestamp
            ...
            <form onSubmit={handleSaveClick}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="datePosted"
                  name="datePosted"
                  value={jobData.datePosted ? formattedDatePosted : ''}
