...
const JobDetails = () => {
  ...
  const handleSaveClick = async () => {
    try {
      const jobDocRef = doc(db, 'jobList', jobId);
      // Convert the formattedDatePosted to a Date object
    const datePosted = parse(formattedDatePosted, 'MMMM dd, yyyy', new Date());
      await updateDoc(jobDocRef, {
        title: jobData.title,
        description: jobData.description,
        company: jobData.company,
        datePosted: parseISO(jobData.datePosted), // Convert date string to Date
