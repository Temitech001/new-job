...
const JobDetails = () => {
  ...
  const handleSaveClick = async (e) => {
    ...
    try {
      const jobDocRef = doc(db, 'jobList', jobId);
      console.log('Before Update:', jobData);
      ...
      await updateDoc(jobDocRef, {
        ...
        location: jobData.location,
         // Only include the "Work Schedule" field if it's not empty
      ...(jobData.workSchedule && { workSchedule: jobData.workSchedule }),
        // Add other fields here
      });
  
      console.log('After Update:', jobData);
      setIsEditing(false);
    } catch (error) {
  ...
  return (
    <div>
      <Header />
      <div className="min-h-screen flex items-center justify-center fill-screen">
