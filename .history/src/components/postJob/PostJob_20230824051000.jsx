...
import { db } from '../server/firebase'; // Import your Firestore db object
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const docRef = await addDoc(collection(db, 'jobList'), {
        ...
        datePosted: new Date(jobData.datePosted), // Convert date to a JavaScript Date object
      ...
      setJobData({
        ...
        company: '',
        datePosted: '',
        salaryRangeMin: 0, // Reset salary range
        salaryRangeMax: 0, // Reset salary range
        jobType: '',
        location: 'Remote',
      });
      setCharCount(0);
